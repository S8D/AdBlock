...
export ht2="${Tam}/ht2.tmp"
export ht1="${Tam}/ht1.tmp"
...
#___________________________________________________________________________________________________________________________________________________________________________________________________
	lognecho "# Downloading: ${u01}";GetSLL ${u01} > $ht1;printFileSize $ht1;cat $ht1 > $ht2;
	lognecho "# Downloading: ${u02}";GetSLL ${u02} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u03}";GetSLL -d mimetype=plaintext -d hostformat=dnsmasq ${u03} > $ht1;
	printFileSize $ht1;cat $ht1 >> $ht2 | printFileSize $ht2;
	lognecho "# Downloading: Main lists"
	lognecho "# Downloading: ${u04}";GetSLL ${u04} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u05}";GetSLL ${u05} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u06}";GetSLL ${u06} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u07}";GetSLL ${u07} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u08}";GetSLL ${u08} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u09}";GetSLL ${u09} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u10}";GetSLL ${u10} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u11}";GetSLL ${u11} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u12}";GetSLL ${u12} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u13}";GetSLL ${u13} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u14}";GetSLL ${u14} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u15}";GetSLL ${u15} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u16}";GetSLL ${u16} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u17}";GetSLL ${u17} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u18}";GetSLL ${u18} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	lognecho "# Downloading: ${u19}";GetSLL ${u19} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
#___________________________________________________________________________________________________________________________________________________________________________________________________
	lognecho "# Downloading: ${u90}";GetSLL ${u90} > $ht1;printFileSize $ht1;cat $ht1 > $Tamt;
	lognecho "# Downloading: ${u91}";GetSLL ${u91} > $ht1;printFileSize $ht1;cat $ht1 >> $Tamt;
	lognecho "# Downloading: ${u92}";GetSLL ${u92} > $ht1;printFileSize $ht1;cat $ht1 >> $Tamt;
	lognecho "# Downloading: ${u93}";GetSLL ${u93} > $ht1;printFileSize $ht1;cat $ht1 >> $Tamt;
	lognecho "# Downloading: ${u94}";GetSLL ${u94} > $ht1;printFileSize $ht1;cat $ht1 >> $Tamt;
	lognecho "# Downloading: ${u95}";GetSLL ${u95} > $ht1;printFileSize $ht1;cat $ht1 >> $Tamt;
	lognecho "# Downloading: ${u96}";GetSLL ${u96} > $ht1;printFileSize $ht1;cat $ht1 >> $Tamt;
	lognecho "# Downloading: ${u97}";GetSLL ${u97} > $ht1;printFileSize $ht1;cat $ht1 >> $Tamt;
	lognecho "# Downloading: ${u98}";GetSLL ${u98} > $ht1;printFileSize $ht1;cat $ht1 >> $Tamt;
	lognecho "# Downloading: ${u99}";GetSLL ${u99} > $ht1;printFileSize $ht1;cat $ht1 >> $Tamt;
	lognecho "> Processing: [0]";LC_ALL=C cat $Tamt | tr '[:upper:]' '[:lower:]' | grep -vE '(#|@|!|\*)' | sed -r "${sed1}" | sort -u > $Host1
	printFileSize $Host1;cat $Host1 >> $ht2;
	lognecho ">>>File size Level [0] is:";printFileSize $ht2;
#___________________________________________________________________________________________________________________________________________________________________________________________________
	if [ $Level -ge 1 ]; then
		lognecho "# Unlocking Level=1 lists"
		lognecho "# Downloading: ${u20}";GetSLL ${u20} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u21}";GetSLL ${u21} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u22}";GetSLL ${u22} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u23}";GetSLL ${u23} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u24}";GetSLL ${u24} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u25}";GetSLL ${u25} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u26}";GetSLL ${u26} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u27}";GetSLL ${u27} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u28}";GetSLL ${u28} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u29}";GetSLL ${u29} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u30}";GetSLL ${u30} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u31}";GetSLL ${u31} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u32}";GetSLL ${u32} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u33}";GetSLL ${u33} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u34}";GetSLL ${u34} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u35}";GetSLL ${u35} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u36}";GetSLL ${u36} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u37}";GetSLL ${u37} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u38}";GetSLL ${u38} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u39}";GetSLL ${u39} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u40}";GetSLL ${u40} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u41}";GetSLL ${u41} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u42}";GetSLL ${u42} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u43}";GetSLL ${u43} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u44}";GetSLL ${u44} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u45}";GetSLL ${u45} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u46}";GetSLL ${u46} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u47}";GetSLL ${u47} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u48}";GetSLL ${u48} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho ">>>File size Level [1] is:";printFileSize $ht2;
	fi
#___________________________________________________________________________________________________________________________________________________________________________________________________
	if [ $Level -ge 2 ]; then
		lognecho "# Unlocking Level=2 lists"
		lognecho "# Downloading: ${u49}";GetSLL ${u49} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u50}";GetSLL ${u50} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u51}";GetSLL ${u51} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u52}";GetSLL ${u52} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u53}";GetSLL ${u53} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u54}";GetSLL ${u54} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u55}";GetSLL ${u55} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u56}";GetHTT ${u56} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u57}";GetHTT ${u57} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u58}";GetSLL ${u58} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u59}";GetSLL ${u59} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u60}";GetSLL ${u60} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u61}";GetSLL ${u61} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u62}";GetSLL ${u62} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u63}";GetSLL ${u63} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u64}";GetSLL ${u64} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u65}";GetSLL ${u65} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u66}";GetSLL ${u66} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u67}";GetSLL ${u67} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u68}";GetSLL ${u68} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u69}";GetSLL ${u69} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u70}";GetSLL ${u70} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u71}";GetSLL ${u71} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u72}";GetSLL ${u72} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u73}";GetSLL ${u73} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u74}";GetSLL ${u74} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u75}";GetSLL ${u75} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u76}";GetSLL ${u76} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u77}";GetSLL ${u77} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho ">>>File size Level [2] is:";printFileSize $ht2;
	fi
#___________________________________________________________________________________________________________________________________________________________________________________________________
	if [ $Level -ge 3 ]; then
		lognecho "# Unlocking Level=3 lists"
		lognecho "# Downloading: ${u78}";GetSLL ${u78} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u79}";GetSLL ${u79} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u80}";GetMHK ${u80} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;		
		lognecho "# Downloading: ${u81}";GetSLL ${u81} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u82}";GetSLL ${u82} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u83}";GetSLL ${u83} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho ">>>File size Level [3] is:";printFileSize $ht2;
	#_________________________________________________________________________________________________________________________________
	lognecho "> Processing: [0]+[1]+[2]+[3]";LC_ALL=C cat $ht2 | tr '[:upper:]' '[:lower:]' | sed -r "${sed2}" | sort -u > $Host1
	printFileSize $Host1;cat $Host1 > $ht2;
	#_________________________________________________________________________________________________________________________________
	fi
	if [ $Level -eq 4 ]; then
		lognecho "# Unlocking Level=4 lists"
		lognecho "# Downloading: ${u84}";GetSLL ${u84} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
		lognecho "# Downloading: ${u100}";GetSLL ${u100} > $ht1;printFileSize $ht1;cat $ht1 >> $ht2;
	fi
	if [ $NOFB = "f" ]; then
		lognecho "# Downloading: ${u85}"
		GetSLL ${Home2Page}/denOn/facebook.only >> $ht2;printFileSize $ht1;cat $ht1 >> $ht2;
	fi
	if [ $NOFB = "F" ]; then
		lognecho "# Downloading: ${u86}";GetSLL ${Home2Page}/denOn/facebook.all >> $ht2;printFileSize $ht1;
		cat $ht1 >> $ht2
	fi
...
#_____________________________________________________________________________________________________________
	...
	[ -s $hChinh ] && cat $hChinh | awk '{print $2}' > $ht2
...
#_____________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
	lognecho "> Deleting: Symbol+Mid-level domains";LC_ALL=C cat $ht2 | tr '[:upper:]' '[:lower:]' | sed -r "${sed6}" | grep -vE "(${SubDM})" | tr -cd '\000-\177' | cat $Tambl - | grep -Fvwf $Tamwl | sed -r "${sed5}" | sort -u | awk -v "IP=$SetIP" '{sub(/\r$/,""); print IP" "$0}' > $hChinh
