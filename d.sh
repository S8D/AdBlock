...
if [ -f $Lv0 ];then
	...
	if [ -f "${TMuc}/Location" ];then
		cat $Lv0 > ${Dl}/_Lv0.txt;cat $tam > ${Dl}/Lv0.txt;
	fi
	rm -f $Lv0;
fi
if [ -f $Lv00 ];then
	...
	if [ -f "${TMuc}/Location" ];then
		cat $Lv00 > ${Dl}/_Lv00.txt;cat $tam > ${Dl}/Lv00.txt
	fi
	rm -f $Lv00;
fi
if [ -f $Lv1 ];then
	...
	if [ -f "${TMuc}/Location" ];then
		cat $Lv1 > ${Dl}/_Lv1.txt;cat $tam > ${Dl}/Lv1.txt
	fi
	rm -f $Lv1;
fi
if [ -f $Lv2 ];then
	...
	if [ -f "${TMuc}/Location" ];then
		cat $Lv2 > ${Dl}/_Lv2.txt;cat $tam > ${Dl}/Lv2.txt
	fi
	rm -f $Lv2;
fi
if [ -f $Lv3 ];then
	...
	if [ -f "${TMuc}/Location" ];then
		cat $Lv3 > ${Dl}/_Lv3.txt;cat $tam > ${Dl}/Lv3.txt
	fi
	rm -f $Lv3;
fi
if [ -f $Lv4 ];then
	...
	if [ -f "${TMuc}/Location" ];then
		cat $Lv4 > ${Dl}/_Lv4.txt;cat $tam > ${Dl}/Lv4.txt
	fi
	rm -f $Lv4;
fi
