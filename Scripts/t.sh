...
curl -s -L -o /root/dns/update.tar.gz https://github.com/DNSCrypt/dnscrypt-proxy/releases/download/2.0.36-beta.1/dnscrypt-proxy-$linktai-2.0.36-beta.1.tar.gz
